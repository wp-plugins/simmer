...
<p>
	...
	<label for="<?php echo $this->get_field_id( 'show_count' ); ?>"><?php _e( 'Show recipe counts', Simmer::SLUG ); ?></label><br />
	...
	<label for="<?php echo $this->get_field_id( 'hierarchical' ); ?>"><?php _e( 'Show hierarchy', Simmer::SLUG ); ?></label>
</p>
