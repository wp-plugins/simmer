...
<fieldset>
	<label for="simmer_on_uninstall_delete_settings" title="<?php _e( 'Delete settings data', Simmer::SLUG ); ?>">
		...
		<span><?php _e( 'Delete settings data but keep saved recipes (recommended).', Simmer::SLUG ); ?></span>
	</label><br>
	<label for="simmer_on_uninstall_keep_all" title="<?php _e( 'Keep all data', Simmer::SLUG ); ?>">
		...
		<span><?php _e( 'Keep all data.', Simmer::SLUG ); ?></span>
	</label><br>
	<label for="simmer_on_uninstall_delete_all" title="<?php _e( 'Delete all data', Simmer::SLUG ); ?>">
		...
		<span><?php _e( 'Delete all data.', Simmer::SLUG ); ?></span>
	</label>
</fieldset>
