...
<fieldset>
	<label for="simmer_ingredients_list_type_ul" title="<?php _e( 'Bulleted List', Simmer::SLUG ); ?>">
	...
	<label for="simmer_ingredients_list_type_ol" title="<?php _e( 'Numbered List', Simmer::SLUG ); ?>">
