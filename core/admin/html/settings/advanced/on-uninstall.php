...
<fieldset>
	<label for="simmer_on_uninstall_delete_settings" title="<?php _e( 'Delete settings data', Simmer()->domain ); ?>">
		...
		<span><?php _e( 'Delete settings data but keep saved recipes (recommended).', Simmer()->domain ); ?></span>
	</label><br>
	<label for="simmer_on_uninstall_keep_all" title="<?php _e( 'Keep all data', Simmer()->domain ); ?>">
		...
		<span><?php _e( 'Keep all data.', Simmer()->domain ); ?></span>
	</label><br>
	<label for="simmer_on_uninstall_delete_all" title="<?php _e( 'Delete all data', Simmer()->domain ); ?>">
		...
		<span><?php _e( 'Delete all data.', Simmer()->domain ); ?></span>
	</label>
</fieldset>
