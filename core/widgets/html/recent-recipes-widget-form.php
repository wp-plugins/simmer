...
<p>
	<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', Simmer()->domain ); ?></label>
	<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $instance['title'] ); ?>" />
</p>

<p>
	<label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of recipes to show:', Simmer()->domain ); ?></label>
...
<p>
	...
	<label for="<?php echo $this->get_field_id( 'show_dates' ); ?>"><?php _e( 'Display relative dates', Simmer()->domain ); ?></label>
</p>
